...
import TaskRepositoy from "../models/repositories/TaskRepository"
...
export default class TaskController{
  public readonly getAll = async (req: Request , res: Response) => { 
    ...
    const repository = new TaskRepositoy(user.sub)
  ...
  public readonly create = async (req: Request , res: Response) => {
      const task = req.body as CreateTaskDTO //Toma los datos de req.body y ojala los trate como CreateTaskDTO
